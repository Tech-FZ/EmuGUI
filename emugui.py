...
class Window(QMainWindow, Ui_MainWindow):
    ...
    def prepareDatabase(self, connection):
        ...
        CREATE TABLE IF NOT EXISTS virtualmachines (
            ...
            tpmtype TEXT DEFAULT "none" NOT NULL,
            tpmdev TEXT
        );
        """
        ...
        select11ColumnsVM = """
        SELECT tpmtype, tpmdev FROM virtualmachines;
        """
        ...
        insertTpmTypeVM = """
        ALTER TABLE virtualmachines
        ADD COLUMN tpmtype TEXT DEFAULT "none" NOT NULL;
        """

        insertTpmDevVM = """
        ALTER TABLE virtualmachines
        ADD COLUMN tpmdev TEXT;
        """
        ...
        try:
            ...
            try:
                cursor.execute(insertTpmTypeVM)
                connection.commit()

                cursor.execute(insertTpmDevVM)
                connection.commit()
    ...
    def startVM(self):
        ...
        try:
            ...
            linuxinitrid, linuxcmd, mousetype, cores, filebios, keyboardtype, usbsupport, usbcontroller, kbdtype, tpmtype, tpmdev
            ...
            with open(tempVmDef, "w+") as tempVmDefFile:
                ...
                tempVmDefFile.write(tpm_type + "\n")
                tempVmDefFile.write(str(tpm_dev) + "\n")
